...
interface IProps {
  ...
  file: null | File;
  setState: Dispatch<SetStateAction<null | File>>;
  placeholder: string;
  title?: string;
  labelId: string;
}
...
const InputImage = ({
  ...
  return (
    <div className="w-full flex flex-col gap-1 relative">
      ...
      {file && (
        <div
          className="w-6 h-6 flex items-center justify-center absolute -top-2 -right-3 bg-red-500 rounded-full cursor-pointer"
